namespace StudentSystem
{
    ...
    public class Startup
    {
        ...
        private static void PrintStudentWithCoursesResoursesAndLicenses(StudentSystemDbContext context)
        {
        ...
        private static void PrintStudentCoursesAndPrice(StudentSystemDbContext context)
        {
        ...
        private static void PrintActiveCourses(StudentSystemDbContext context)
        {
        ...
        private static void PrintCoursesWithMoreThan5Resources(StudentSystemDbContext context)
        {
        ...
        private static void PrintStudentsWithHomeworkSubmissions(StudentSystemDbContext context)
        {
        ...
        private static void SeedHomeworks(StudentSystemDbContext context, List<Course> addedCourses)
        {
        ...
        private static void SeedResources(StudentSystemDbContext context, List<Course> addedCourses)
        {
        ...
        private static void SeedStudentsToCourses(StudentSystemDbContext context, List<Course> addedCourses)
        {
        ...
        private static List<Course> SeedCourses(StudentSystemDbContext context)
        {
